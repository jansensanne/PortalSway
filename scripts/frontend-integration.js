 ...
 * This file demonstrates how to integrate Portalsway with a web frontend
 */

// For React/Vue/Angular applications
export class PortalswayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new PortalswayClient(provider, contractAddress);
